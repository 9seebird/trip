...
export const seed:Project[] = [
 ...
 {id:9,name:'한옥 담, 북촌',region:'서울 · 북촌',type:'한옥 스테이',stage:5,owner:'박지훈',date:'2026-08-25',time:'09:00',due:'2026-08-29',photos:30,cover:10,channels:[true,true,true],note:''},
 {id:10,name:'숲속 작은 집',region:'춘천 · 남산면',type:'독채 스테이',stage:5,owner:'김서연',date:'2026-08-20',time:'13:00',due:'2026-08-26',photos:22,cover:16,channels:[true,true,true],note:''},
];
